<?php
/**
 * Happy Tails Theme functions and definitions
 *
 ...
 */
function happy_tails_theme_setup() {

	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on Happy Tails Theme, use a find and replace
	 * to change 'happy-tails-theme' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'happy-tails-theme', get_template_directory() . '/languages' );
 ...
 */
function happy_tails_theme_widgets_init() {
...
add_action( 'widgets_init', 'happy_tails_theme_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'happy_tails_theme_scripts' );
